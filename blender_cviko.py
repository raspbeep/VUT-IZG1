...
#all necessary matrix or vector operations can be found at https://docs.blender.org/api/current/mathutils.html
    ...
    def createView():
        ...
        #Z = Z @ mathutils.Matrix.Rotation(radians(180.0),4,'X')
        
        
        Z = Z @ mathutils.Matrix.Rotation(radians(167.0),4,'Z')
    ...
    def createTransformation(object, view):
        ...
        transformation = transformation @ mathutils.Matrix.Rotation(radians(90.0),4,'X')
        #transformation = transformation @ mathutils.Matrix.Rotation(radians(90.0),4,'Y')
        transformation = transformation @ mathutils.Matrix.Rotation(radians(270.0),4,'Z')
        transformation = transformation @ mathutils.Matrix.Translation((0, objectNumber ,0))
